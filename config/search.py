...
search_terms = ["Software Engineer", "Software Developer", "Python Developer", "Machine Learning Developer", "Java Developer", "Artificial Intelligence Developer", "C++ Developer", "Python Engineer", "Machine Learning Engineer",
               "AI Developer", "A.I. Developer", "ML Developer", "AI/ML Developer", "AI/ML Engineer"]
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
